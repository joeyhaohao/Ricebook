...
const config = { url: 'https://yz157-ricebook.herokuapp.com', options: {} };
...
let AuthComponent = class AuthComponent {
    constructor(authServ, postServ, chatServ, formBuilder) {
...
let AuthService = class AuthService {
    constructor(http, router, chatServ) {
        this.http = http;
        this.router = router;
        this.chatServ = chatServ;
...
let ChatComponent = class ChatComponent {
    constructor(socket, followServ, http) {
        this.socket = socket;
    ...
    initSocketListeners() {
        ...
        this.socket.on("createSocketId", (socketId) => {
            ...
            this.adapter = new _socket_adapter__WEBPACK_IMPORTED_MODULE_2__["SocketAdapter"](this.userId, this.socket, this.http);
        });
    }
    ngOnInit() {
    }
...
class SocketAdapter extends ng_chat__WEBPACK_IMPORTED_MODULE_1__["ChatAdapter"] {
    constructor(userId, socket, http) {
        super();
    ...
    //   }];
    listFriends() {
        return this.http.get(this.server + '/chatFriends', { withCredentials: true }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(res => {
            ...
            if (friendList instanceof Array) {
                ...
                friendList.forEach(friend => {
                    ...
                    let participantResponse = new ng_chat__WEBPACK_IMPORTED_MODULE_1__["ParticipantResponse"]();
    ...
    initSocketListeners() {
        ...
        this.socket.on("friendListUpdate", (socketUsers) => {
            console.log("update");
...
let ArticleComponent = class ArticleComponent {
    constructor(artiServ, profServ, modalService) {
...
let MainComponent = class MainComponent {
    constructor(authServ, artiServ, profServ, followServ) {
        this.authServ = authServ;
        this.artiServ = artiServ;
        this.profServ = profServ;
        this.followServ = followServ;
...
let ProfileComponent = class ProfileComponent {
    constructor(profServ, authServ, formBuilder) {
        this.profServ = profServ;
        this.authServ = authServ;
        this.formBuilder = formBuilder;
        this.profile = this.profServ.profile;
